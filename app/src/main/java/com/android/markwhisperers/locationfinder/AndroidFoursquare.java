...
public class AndroidFoursquare extends ListActivity {
    ...
    final String CLIENT_ID = "1AGKZKCRONHUNMYF4GGM0XTCO5R4B5KWAL3GUWX50E5JA0UW";
    final String CLIENT_SECRET = "BPUARGPO4F5DQEQFJJPOVADKKKNEOGTGQYBUTRYGCZBJPK3B";
    ...
    private class fourquare extends AsyncTask<View, Void, String>  {
        ...
        protected void onPostExecute(String result) {
            if (temp == null) {
                ...
                myAdapter = new ArrayAdapter(AndroidFoursquare.this, R.layout.rowlayout ,R.id.textView1, listTitle);
